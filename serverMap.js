 ...
 * @param driverData: the profile of THIS driver requesting for data
        ...
        .then((passengerData) => {
            if (passengerData !== undefined && passengerData.length > 0) {
                ...
                parsedRequestsArray.ride_basic_infos.passengers_number =
                    parseInt(request.passengers_number);
                parsedRequestsArray.ride_basic_infos.request_type =
                    request.request_type;
                parsedRequestsArray.ride_basic_infos.ride_mode =
                    request.ride_mode;
                parsedRequestsArray.ride_basic_infos.ride_style =
                    request.ride_style;
